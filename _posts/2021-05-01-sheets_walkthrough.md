...
At this point you have imported the CSV file to your Sheet, you have named the Sheet and you have duplicated it so that you have a copy of the original data if you need it. You've also added the source for the data so that if you come back to work on this in six months you'll know where the data came from.
